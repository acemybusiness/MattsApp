const CACHE_NAME='matts-square-v80-domain-pwa-fix';
const APP_SHELL=['./','./index.html','./shared.html','./msa-logo.png','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
